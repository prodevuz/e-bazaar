          ...
          children: [
            ...
            RoundedContainer(
              ...
              child: Stack(
                children: [
                  /// Thumbnail Image
                  RoundedImage(imageUrl: image, applyImageRadius: true), // productImage1

                  /// Sole Tag
                  Positioned(top: ADSizes.sm + 12, left: ADSizes.sm, child: RoundedContainer(radius: ADSizes.sm, backgroundColor: ADColors.secondary.withOpacity(0.8), padding: const EdgeInsets.symmetric(horizontal: ADSizes.sm, vertical: ADSizes.xs), child: Text('25%', style: Theme.of(context).textTheme.labelLarge!.apply(color: ADColors.black)))),

                  /// Favorite Button
                  const Positioned(top: ADSizes.sm, right: ADSizes.sm, child: CircularIcon(icon: Iconsax.heart5, color: Colors.red)),
                ],
              ),
            ),

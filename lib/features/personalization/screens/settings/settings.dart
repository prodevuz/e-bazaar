              ...
              Row(children: [
                Expanded(
                  ...
                  child: ADAppBar(
                    title: Text(
                      'Hisob',
                      style: Theme.of(context).textTheme.headlineMedium!.apply(color: ADColors.white),
                    ),
                  ),
                ),
                Expanded(
          ...
          Padding(
            ...
            child: Column(children: [
              ...
              SettingsMenuTile(
                ...
                title: "Savat",
                subTitle: "Maxsulotlarni qo'shing, olib tashlang va buyurtma bering",
                onTap: () => Get.to(() => const CartScreen()),
              ),
              SettingsMenuTile(
                icon: Iconsax.bag_tick,
                title: "Buyurtmalarim",
                subTitle: "Jarayondagi va tugallangan buyurtmalar",
                onTap: () => Get.to(() => const OrderScreen()),
              ),
              SettingsMenuTile(
                icon: Iconsax.bank,
                title: "Bank hisobi",
                subTitle: "Bank hisobi balansi",
                onTap: () => Get.to(() => const UserAddressScreen()),
              ),
              SettingsMenuTile(
                icon: Iconsax.discount_shape,
                title: "Kuponlarim",
                subTitle: "Chegirma kuponlar ro'yxati",
                onTap: () => Get.to(() => const UserAddressScreen()),
              ),
              SettingsMenuTile(
                icon: Iconsax.notification,
                title: "Bildirishnomalar",
                subTitle: "Har qanday turdagi bildirishnoma xabarini belgilang",
                onTap: () => Get.to(() => const UserAddressScreen()),
              ),
              SettingsMenuTile(
                icon: Iconsax.security_card,
                title: "Hisob maxfiyligi",
                subTitle: "Ma'lumotdan foydalanish va ulangan hisoblarni boshqaring",
                onTap: () => Get.to(() => const UserAddressScreen()),
              ),
              ...
              SettingsMenuTile(
                ...
                title: "Geojoylashuv",
                subTitle: "Joylashuvga moslangan tavsiyalar",
                trailing: Switch(value: true, onChanged: (value) {}),
              ),
              SettingsMenuTile(
                icon: Iconsax.security_user,
                title: "Xavfsiz rejim",
                subTitle: "Barcha yoshdagilar uchun xavfsiz maxsulotlar",
                trailing: Switch(value: false, onChanged: (value) {}),
              ),
              SettingsMenuTile(
                icon: Iconsax.image,
                title: "HD sifatli rasmlar",
                subTitle: "Rasmlar sifatini belgilang",
                trailing: Switch(value: false, onChanged: (value) {}),
              ),

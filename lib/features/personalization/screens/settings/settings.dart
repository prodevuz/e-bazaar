        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: Column(children: [
              ...
              const SizedBox(height: ADSizes.spaceBtwItems),
              SettingsMenuTile(icon: Iconsax.document_upload, title: "Ma'lumot yuklang", subTitle: "Cloud Firebasega ma'lumot yuklang", onTap: () => Get.put(ADDummyUpload()).uploadDummyData()),
